...
export const RecoverView = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const success = await recoverPassword(formData.Email);
  ...
  return (
    <div className="bg-white w-full max-w-md rounded-3xl overflow-hidden shadow-2xl p-10 flex flex-col justify-center items-center text-center">
      <span className="text-[11px] font-semibold text-gray-400 tracking-widest uppercase mb-1">Recuperar Contraseña</span>
      <img src={logo} alt="Tconecta Logo" className="h-14 mb-4" />
      <p className="text-sm text-gray-500 mb-8">Ingresa tu correo electrónico para recuperar tu contraseña.</p>
